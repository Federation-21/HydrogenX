    ...
    <section id="cb-hero-bg" class="overflow-hidden cb-hero relative">
        ...
        <div class="container">
            <div class="flex flex-col justify-center text-white">
                ...
                <p class="mx-auto md:text-base xs:text-sm text-center">Book a call with a product expert to evaluate your
                    project.</p>
            </div>
        </div>
    </section>
            ...
            <div class="lg:flex shadow-lg rounded-lg bg-gray-100 dark:bg-darkviolet">
                <div class="lg:w-1/3 mb-4 lg:mb-0">
                    <div class="cb-contact-info">
                        ...
                        <ul class="cb-social">
                            <li>
                                <a target="_blank" href="https://facebook.com/codebumble">
                            ...
                            <li>
                                <a target="_blank" href="https://instagram.com/codebumble">
                            ...
                            <li>
                                <a target="_blank" href="https://www.linkedin.com/company/codebumble">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                                        <path
                            ...
                            <li>
                                <a target="_blank" href="https://twitter.com/codebumble">
